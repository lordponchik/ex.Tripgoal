...
},{}],"xnLb":[function(require,module,exports) {
"use strict";
...
var instagrammListEl = document.querySelector(".instagramm__list");
function instRender(data) {
  return data.map(function (_ref) {
    var name = _ref.name,
      alt = _ref.alt;
    return "<li class=\"instagramm__item\">\n              <img\n                src=\"./image/instagram-profile/".concat(name, ".jpg\"\n                alt=\"").concat(alt, "\"\n                class=\"instagramm__img\"\n                height=\"300\"\n                width=\"400\"\n              />\n            </li>");
  }).join("");
}
instagrammListEl.innerHTML = instRender(_instagramData.instagramData);

// console.log(instagramData);
},{"./instagramData.js":"xnLb"}],"Focm":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=/ex.Tripgoal/src.66053c79.js.map